...
var WorldClient = (function (_super) {
    ...
    WorldClient.prototype.pullData = function (name) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2, pxtCloudApi.DataRepo.encode(this._datarepo.getData(name))];
            });
        });
    };
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4, this._promiseEvent(pxtCloudApi.Events.WorldPushDataDiff, { name: name, diff: diff })];
                    case 1:
                        _a.sent();
                        _a.label = 2;
                    case 2: return [2];
        ...
        switch (event) {
            ...
            case pxtCloudApi.Events.WorldPushDataDiff: {
                ...
                if (this._datarepo.isDataSource(name_2)) {
                    this._datarepo.applyDataDiff(name_2, pxtCloudApi.DataRepo.decode(diff));
                }
                break;
            }
        }
