...
var ChatClient = (function (_super) {
    ...
    ChatClient.prototype._onConnect = function (socket$$1) {
        ...
        this._onNotifyReceivedEvent(eventNewMessage, socket$$1);
    };
    ChatClient.prototype._onDisconnect = function (socket$$1) {
        this._offNotifyReceivedEvent(eventNewMessage, socket$$1);
    };
    return ChatClient;
}(client_1.Client));
...
var UsersClient = (function (_super) {
    ...
    UsersClient.prototype._onConnect = function (socket$$1) {
        _super.prototype._onConnect.call(this, socket$$1);
        this._onNotifyReceivedEvent(eventUserJoined, socket$$1);
        this._onNotifyReceivedEvent(eventUserLeft, socket$$1);
    };
    UsersClient.prototype._onDisconnect = function (socket$$1) {
        this._offNotifyReceivedEvent(eventUserLeft, socket$$1);
        this._offNotifyReceivedEvent(eventUserJoined, socket$$1);
    };
    return UsersClient;
}(client_1.Client));
