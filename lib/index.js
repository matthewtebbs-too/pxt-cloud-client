...
var WorldClient = (function (_super) {
    ...
    WorldClient.prototype.syncDataSource = function (name) {
        ...
        return diff_ ? this.syncDataDiff(name, diff_) : bluebird.resolve([]);
    };
    WorldClient.prototype.syncDataDiff = function (name, diff_) {
        return diff_.length > 0 ? this._promiseEvent(pxtCloudApi.Events.WorldSyncDataDiff, { name: name, diff_: diff_ }) : bluebird.resolve([]);
    };
    return WorldClient;
}(client_1.Client));
