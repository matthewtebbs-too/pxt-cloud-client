...
var Client = (function (_super) {
    ...
    Client.prototype.connect = function (uri, nsp) {
        ...
        return new Promise(function (resolve, reject) {
            if (!client_config.ClientConfig.enabled) {
                resolve();
                return;
            }
            var options = {
            ...
            var socket$$1 = socket((uri || client_config.ClientConfig.defaultUri || '') + "/pxt-cloud" + (nsp ? "/" + nsp : ''), options);
    ...
    Client.prototype.dispose = function () {
        if (this._socket) {
            var parsed = url_1(this._socket.io.uri);
...
var WorldClient = (function (_super) {
                ...
                switch (_a.label) {
                    case 0:
                        ...
                        this._datarepo.names.forEach(function (name) {
                            return tencdata.push({ name: name, data: pxtCloudApi.DataRepo.encode(_this._datarepo.getData(name)) });
                        });
                        return [4, this._promiseEvent(pxtCloudApi.Events.WorldPushAllData, { tencdata: tencdata, unlock: unlock })];
                    case 1:
                        _a.sent();
                        return [2];
                }
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4, this._promiseEvent(pxtCloudApi.Events.WorldPushDataDiff, { name: name, encdiff: pxtCloudApi.DataRepo.encodeArray(diff), unlock: unlock })];
                    case 1:
                        _a.sent();
                        return [3, 4];
                    case 2:
    ...
    WorldClient.prototype.lockData = function (name) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4, this._promiseEvent(pxtCloudApi.Events.WorldLockData, name)];
                    case 1: return [2, _a.sent()];
                }
            });
        });
    ...
    WorldClient.prototype.unlockData = function (name) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4, this._promiseEvent(pxtCloudApi.Events.WorldUnlockData, name)];
                    case 1: return [2, _a.sent()];
                }
            });
        });
        ...
        switch (event) {
            ...
            case pxtCloudApi.Events.WorldPushDataDiff: {
                ...
                if (this._datarepo.isDataSource(name_2)) {
                    this._datarepo.applyDataDiff(name_2, pxtCloudApi.DataRepo.decode(encdiff), true);
                }
                break;
            }
        }
...
__export(client_);
__export(client_config);
__export(client_chat);
__export(client_users);
__export(client_world);
...
function makeAPIConnection(uri) {
    return new Promise(function (resolve, reject) {
        ...
        var clients = {
            chat: new client_chat.ChatClient(),
            users: new client_users.UsersClient(),
            world: new client_world.WorldClient(),
        };
        Promise.all([
